...
pub fn flag_namespace_filter_test() {
  use conn <- db.db_connection(":memory:")
  flag.set(conn, "ns1", "flag", "val") |> should.be_ok()
  flag.set(conn, "ns2", "flag", "val") |> should.be_ok()
...
pub fn flag_name_filter_test() {
  use conn <- db.db_connection(":memory:")
  flag.set(conn, "ns", "flag1", "val") |> should.be_ok()
  flag.set(conn, "ns", "flag2", "val") |> should.be_ok()
...
pub fn flag_multiple_filter_test() {
  use conn <- db.db_connection(":memory:")
  flag.set(conn, "ns1", "flag1", "val") |> should.be_ok()
  flag.set(conn, "ns1", "flag2", "val") |> should.be_ok()
  flag.set(conn, "ns2", "flag1", "val") |> should.be_ok()
  flag.set(conn, "ns2", "flag2", "val") |> should.be_ok()
